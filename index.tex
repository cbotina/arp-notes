...
\input{sections/introduction_to_decision_making}
\input{sections/problem_solving_stages}
\input{sections/intelligent_agents}
\input{sections/intelligent_agents_architectures}

% Summary
\input{sections/summary_mindmap}
