...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Perceptual-motor module}: Manages interaction with the environment, handling the flow of perception and action to connect the agent with the world.
